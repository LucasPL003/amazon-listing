...
- Japan patents/utility models, designs, and trademarks: https://www.j-platpat.inpit.go.jp/
...
For JP, complete separate J-PlatPat recalls for patents/utility models, designs, and trademarks. Only rendered HTTPS pages on `j-platpat.inpit.go.jp` qualify as the mandatory official-registry source. Preserve a distinct screenshot for each category; an unconfirmed zero result does not complete the checkpoint.
